let DB;
// enter values in variable in database
...
document.addEventListener('DOMContentLoaded', () => {
     ...
     // adding new or more than one consultaion data
     ScheduleDB.onupgradeneeded = function(e) {
          ...
          objectStore.createIndex('contact', 'contact', { unique: false } );// can be same for mulitple entries
          objectStore.createIndex('date', 'date', { unique: false } );// can be same for mulitple entries
          objectStore.createIndex('time', 'time', { unique: false } );// can be same for mulitple entries
          objectStore.createIndex('symptoms', 'symptoms', { unique: false } );// can be same for mulitple entries

          //console.log('Database ready and fields created!');
     }
// storing values in structure and showing on page
     ...
     function showConsultations() {
          ...
          while(consultations.firstChild) { // used to cancel previous consultaions
